    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-4 gap-4 mb-6">
            <div class="border p-3 text-center">
                ...
                <p class="text-xl font-bold">{{ $pengajuans->count() }}</p>
            </div>
            <div class="border p-3 text-center">
            ...
            <div class="border p-3 text-center">
                ...
                <p class="text-xl font-bold text-yellow-600">{{ $pengajuans->whereIn('status', ['pending_operator', 'pending_kabid'])->count() }}</p>
            </div>
            <div class="border p-3 text-center">
                <p class="text-sm text-gray-500">Ditolak</p>
                <p class="text-xl font-bold text-red-600">{{ $pengajuans->whereIn('status', ['rejected_operator', 'rejected_kabid'])->count() }}</p>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-300 px-2 py-1 text-xs">
                            @switch($pengajuan->status)
                                @case('pending_operator') Menunggu Op @break
