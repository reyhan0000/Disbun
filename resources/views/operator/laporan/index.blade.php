        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('operator.laporan.filter') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                        ...
                        <div>
                            <x-input-label for="nama_kelompok" value="{{ __('Nama Kelompok Tani') }}" />
                        ...
                        <div class="md:col-span-4 flex gap-2">
                            ...
                            <a href="{{ route('operator.laporan.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-gray-400 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400">
                                Reset
                            </a>
                            <a href="{{ route('operator.laporan.print', request()->query()) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Kelompok Tani</th>
