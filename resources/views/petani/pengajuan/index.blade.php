            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-bold text-gray-800">Data Pengajuan</h3>
                        <a href="{{ route('petani.pengajuan.create') }}" class="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold py-2 px-4 rounded shadow-md transform transition hover:-translate-y-0.5">
                            + Buat Pengajuan Baru
                        </a>
                    </div>
                    <form method="GET" action="{{ route('petani.pengajuan.index') }}" class="mb-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-end space-x-2">
                                ...
                                <a href="{{ route('petani.pengajuan.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded shadow">
                                    Reset
                                </a>
                            </div>
                        </div>
                            ...
                            @forelse($pengajuans as $pengajuan)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('petani.pengajuan.show', $pengajuan) }}" class="text-emerald-600 hover:text-emerald-900 font-semibold flex items-center">
                                            Lihat Detail
